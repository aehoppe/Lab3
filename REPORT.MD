...
### Block Diagram
<img src="" alt="top-level-block-diagram" style="width:600px"

Our single-cycle CPU is divided up into two main modules, with one shared memory between all of them. This design arose because we originally
